...
public class ServicesList extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressbar =  (LinearLayout)findViewById(R.id.serviceslistprogresslayout);

        mainwebview = (WebView) findViewById(R.id.serviceslistwebview);
        mainwebview.setVisibility(View.INVISIBLE);
        mainwebview.getSettings().setJavaScriptEnabled(true);
        mainwebview.setWebViewClient(new ServicesListWebViewClient());
        mainwebview.setWebChromeClient(new ServicesListWebChromeClient());

        mainwebview.loadUrl(activityUrlLink.getServicesList(context,
    ...
    private class ServicesListWebViewClient extends WebViewClient {
        @Override
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(sendData[0].trim().equalsIgnoreCase("providerprofile")){
                Intent intent = new Intent(context, ServiceProvidor.class);
    ...
    private class ServicesListWebChromeClient extends WebChromeClient {
...
//            super.onReceivedTouchIconUrl(view, url, precomposed);
    ...
    private void initializeSwipeLayout() {
        swipeLayout = (SwipeRefreshLayout) findViewById(R.id.serviceslistswipe);
